/// <summary>
/// Table DSVC Deposit Entry (ID 70500).
/// </summary>
table 70500 "DSVC Deposit Entry"
{
    LookupPageId = "DSVC Deposit Entry";
    DrillDownPageId = "DSVC Deposit Entry";
    ...
    fields
    {
        ...
        field(2; "Document Type"; Enum "DSVC Deposit Type")
        {
